...
**Enums:** AltScreenClear,AnsiCommand,AppEvent,Attribute,C0Control,CharacterSet,Color,ControlEvent,CsiCommand,CursorShape,CursorVisibility,EmulatorAction,EmulatorInput,EscCommand,Glyph,KeySymbol,LineState,Mode,ModeAction,NamedColor,ScrollHistory,SelectionMode,StandardModeConstant,TabClearMode,UserInputAction
...
**Structs:** Abs,Add,AddMasked,And,At,AtArray,BNot,BoxedManifold,Cos,Div,F32x4,Fix,Floor,Ge,Gt,Le,Lt,Map,Mask4,MaskScalar,Max,Min,Mul,MulAdd,MulRecip,MulRsqrt,Neon,Or,Pack,PathJet,Project,Rsqrt,Scalar,ScalarF32,ScalarU32,Select,Sh2Field,ShCoeffs,ShProject,ShReconstruct,Sin,SoftGt,SoftLt,SoftSelect,SphericalHarmonic,Sqrt,Sub,Texture,Thunk,U32x4,W,X,Y,Z,ZonalHarmonic
...
**Structs:** AACoverage,Affine,AttrFlags,Baked,BezierPatch,Bgra8,CachedGlyph,CachedText,Checker,ColorChecker,ColorCube,ColorManifold,ColorReflect,ColorScreenToDir,ColorSky,ColorSurface,Curve,DataSource,EmbeddedSource,Font,Frame,Geometry,GeometryColor,GeometryMask,GlyphCache,Grayscale,HeightFieldGeometry,Image,Lift,Line,LoadedFont,Map,MmapSource,OptLine,OptQuad,Oscillate,PlaneGeometry,Rasterize,Reflect,RenderOptions,Rgba8,Scale,SceneObject,ScreenToDir,Sky,Stripe,Sum,Surface,TensorShape,Text,Translate,Union,UnitSphere,W,X,Y,Z

**Traits:** FontSource,GlyphExt,Manifold,ManifoldExt,Pixel,Scene

**Enums:** Color,Glyph,NamedColor

**Functions:** aa_coverage,affine,annulus,circle,ellipse,execute,execute_stripe,half_plane_x,half_plane_y,rectangle,render_parallel,render_parallel_pooled,render_work_stealing,screen_remap,square,threshold,time_shift
