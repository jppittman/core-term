...
pub enum BackendEvent {
    ...
    Key {
        ...
        text: String,
        /// Modifier keys (Shift, Control, Alt, Super) state.
    ...
    Mouse {
        ...
        button: Option<MouseButton>, // None for move events or if button is not applicable
        x: usize,                    // X coordinate, typically in cells
        y: usize,                    // Y coordinate, typically in cells
        modifiers: crate::config::Modifiers,
    },
}
...
pub enum MouseButton {
    ...
    Right,
    Middle,
    ScrollUp,   // Often represented as a button press
    ScrollDown, // Often represented as a button press
    Other(u8),  // For other buttons if any
}
