...
mod tests {
    ...
    fn test_box_drawing_char_widths() {
        ...
        assert_eq!(get_char_display_width('─'), 1, "Width of U+2500 BOX DRAWINGS LIGHT HORIZONTAL");
        assert_eq!(get_char_display_width('│'), 1, "Width of U+2502 BOX DRAWINGS LIGHT VERTICAL");
        assert_eq!(get_char_display_width('┌'), 1, "Width of U+250C BOX DRAWINGS LIGHT DOWN AND RIGHT");
        assert_eq!(get_char_display_width('┐'), 1, "Width of U+2510 BOX DRAWINGS LIGHT DOWN AND LEFT");
        assert_eq!(get_char_display_width('└'), 1, "Width of U+2514 BOX DRAWINGS LIGHT UP AND RIGHT");
        assert_eq!(get_char_display_width('┘'), 1, "Width of U+2518 BOX DRAWINGS LIGHT UP AND LEFT");
        assert_eq!(get_char_display_width('├'), 1, "Width of U+251C BOX DRAWINGS LIGHT VERTICAL AND RIGHT");
        assert_eq!(get_char_display_width('┤'), 1, "Width of U+2524 BOX DRAWINGS LIGHT VERTICAL AND LEFT");
        assert_eq!(get_char_display_width('┬'), 1, "Width of U+252C BOX DRAWINGS LIGHT DOWN AND HORIZONTAL");
        assert_eq!(get_char_display_width('┴'), 1, "Width of U+2534 BOX DRAWINGS LIGHT UP AND HORIZONTAL");
        assert_eq!(get_char_display_width('┼'), 1, "Width of U+253C BOX DRAWINGS LIGHT VERTICAL AND HORIZONTAL");
    ...
    fn test_cjk_wide_char_widths() {
        ensure_locale_initialized();
        assert_eq!(get_char_display_width('世'), 2, "Width of '世' (U+4E16) should be 2");
        assert_eq!(get_char_display_width('界'), 2, "Width of '界' (U+754C) should be 2");
        assert_eq!(get_char_display_width('你'), 2, "Width of '你' (U+4F60) should be 2");
        assert_eq!(get_char_display_width('好'), 2, "Width of '好' (U+597D) should be 2");
    }
    ...
    fn test_control_char_widths() {
        ...
        assert_eq!(get_char_display_width('\u{0000}'), 0, "Width of NUL (U+0000) should be 0");
        assert_eq!(get_char_display_width('\u{0007}'), 0, "Width of BEL (U+0007) should be 0");
        assert_eq!(get_char_display_width('\u{001B}'), 0, "Width of ESC (U+001B) should be 0");
        // Check a C1 control character (e.g., IND - Index U+0084)
        // Rust's char::is_control should cover C1 too.
        assert_eq!(get_char_display_width('\u{0084}'), 0, "Width of IND (U+0084) should be 0");
    }
    ...
    fn test_zero_width_chars() {
        ...
        assert_eq!(get_char_display_width('\u{200D}'), 0, "Width of ZWJ (U+200D) should be 0");
        ...
        assert_eq!(get_char_display_width('\u{0301}'), 0, "Width of Combining Acute Accent (U+0301) should be 0");
    }
    ...
    fn test_locale_initializer_called() {
        ...
        ensure_locale_initialized();
        assert!(GLOBAL_LOCALE_INITIALIZER.get().is_some(), "LocaleInitializer should be initialized after first call to get_char_display_width.");
