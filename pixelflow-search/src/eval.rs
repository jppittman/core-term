//! # Evaluation and Data Generation for PixelFlow Search
//!
//! This module provides tools for generating training data and evaluating
//! expression costs, powering the "Self-Play" aspect of the search engine.
//!
//! 1. **Expression Generation**: Generate random algebraic "positions".
//! 2. **Rewrite Enumeration**: Find valid "moves" (rewrites).
//! 3. **Benchmarking**: Measure the "score" (cost).
//!
//! ## Usage
//!
//! ```ignore
