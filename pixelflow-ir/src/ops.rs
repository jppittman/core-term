...
define_op!(13, MulRsqrt, "mul_rsqrt", 2, BinaryMethod);

// --- Extended Math ---
define_op!(14, Recip,    "recip",     1, UnaryMethod);
define_op!(15, Floor,    "floor",     1, UnaryMethod);
define_op!(16, Ceil,     "ceil",      1, UnaryMethod);
define_op!(17, Round,    "round",     1, UnaryMethod);
define_op!(18, Fract,    "fract",     1, UnaryMethod);

// --- Trigonometry ---
define_op!(19, Sin,      "sin",       1, UnaryMethod);
define_op!(20, Cos,      "cos",       1, UnaryMethod);
define_op!(21, Tan,      "tan",       1, UnaryMethod);
define_op!(22, Asin,     "asin",      1, UnaryMethod);
define_op!(23, Acos,     "acos",      1, UnaryMethod);
define_op!(24, Atan,     "atan",      1, UnaryMethod);
define_op!(25, Atan2,    "atan2",     2, BinaryMethod);

// --- Exponentials ---
define_op!(26, Exp,      "exp",       1, UnaryMethod);
define_op!(27, Exp2,     "exp2",      1, UnaryMethod);
define_op!(28, Ln,       "ln",        1, UnaryMethod);
define_op!(29, Log2,     "log2",      1, UnaryMethod);
define_op!(30, Log10,    "log10",     1, UnaryMethod);
define_op!(31, Pow,      "pow",       2, BinaryMethod);
define_op!(32, Hypot,    "hypot",     2, BinaryMethod);

// --- Comparison ---
define_op!(33, Lt,       "lt",        2, BinaryMethod);
define_op!(34, Le,       "le",        2, BinaryMethod);
define_op!(35, Gt,       "gt",        2, BinaryMethod);
define_op!(36, Ge,       "ge",        2, BinaryMethod);
define_op!(37, Eq,       "eq",        2, BinaryMethod);
define_op!(38, Ne,       "ne",        2, BinaryMethod);

// --- Control Flow ---
define_op!(39, Select,   "select",    3, TernaryMethod);
define_op!(40, Clamp,    "clamp",     3, TernaryMethod);

// --- Structure ---
define_op!(41, Tuple,    "tuple",     0, Special);

/// Total number of operations.
pub const OP_COUNT: usize = 42;
