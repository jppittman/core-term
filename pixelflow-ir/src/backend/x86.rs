...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            // Extract exponent n = (exponent_bits >> 23) - 127
            // Use shift and convert to float (standard method)
            let exp_shifted = _mm_srli_epi32(x_i32, 23);
            let bias = _mm_set1_epi32(127);
            let mut n = _mm_cvtepi32_ps(_mm_sub_epi32(exp_shifted, bias));
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let mut n = _mm256_cvtepi32_ps(_mm256_sub_epi32(exp_shifted, bias));
