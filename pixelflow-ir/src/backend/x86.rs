...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            let sqrt2 = _mm_set1_ps(consts::SQRT_2);
    ...
    fn exp2(self) -> Self {
        ...
        unsafe {
            ...
            let c1 = _mm_set1_ps(consts::LN_2);
...
impl U32x4 {
    ...
    #[allow(dead_code)]
    #[inline(always)]
    pub(crate) fn pack_rgba(r: F32x4, g: F32x4, b: F32x4, a: F32x4) -> Self {
        unsafe {
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            // Adjust to [√2/2, √2] range for better accuracy (centered at 1)
            // If f >= √2, divide by 2 and increment exponent
            let sqrt2 = _mm256_set1_ps(consts::SQRT_2);
    ...
    fn exp2(self) -> Self {
        unsafe {
            ...
            let c1 = _mm256_set1_ps(consts::LN_2);
...
impl SimdOps for F32x16 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            // Adjust to [√2/2, √2] range for better accuracy (centered at 1)
            // If f >= √2, divide by 2 and increment exponent
            let sqrt2 = _mm512_set1_ps(consts::SQRT_2);
    ...
    fn exp2(self) -> Self {
        ...
        unsafe {
            ...
            let c1 = _mm512_set1_ps(consts::LN_2);
