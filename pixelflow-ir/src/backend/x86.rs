...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            let exp_unbiased = _mm_sub_epi32(
                _mm_and_si128(exp_bits, _mm_set1_epi32(0xFF)),
                _mm_set1_epi32(127),
            );
            let mut n = _mm_cvtepi32_ps(exp_unbiased);

            // Extract mantissa in [1, 2)
            // (x & 0x007FFFFF) | 0x3F800000 (which is 1.0)
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let exp_unbiased = _mm256_sub_epi32(
                _mm256_and_si256(exp_bits, _mm256_set1_epi32(0xFF)),
