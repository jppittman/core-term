...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            let n_int = _mm_sub_epi32(exp_bits, bias);
            let mut n = _mm_cvtepi32_ps(n_int);

            // Extract mantissa in [1, 2): f = (x & 0x007FFFFF) | 0x3F800000
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let n_int = _mm256_sub_epi32(exp_bits, bias);
            let mut n = _mm256_cvtepi32_ps(n_int);
