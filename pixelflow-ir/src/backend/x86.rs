...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            let sqrt2 = _mm_set1_ps(1.414_213_562_4);
            ...
            // Max error: ~1e-4
            let c4 = _mm_set1_ps(-0.320_043_515_9);
            let c3 = _mm_set1_ps(1.797_496_915_4);
            let c2 = _mm_set1_ps(-4.198_804_617_6);
            let c1 = _mm_set1_ps(5.727_023_169_5);
            let c0 = _mm_set1_ps(-3.005_614_671_4);
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            // Adjust to [√2/2, √2] range for better accuracy (centered at 1)
            // If f >= √2, divide by 2 and increment exponent
            let sqrt2 = _mm256_set1_ps(1.414_213_562_4);
            ...
            // Fitted using least squares on Chebyshev nodes
            // Max error: ~1e-4
            let c4 = _mm256_set1_ps(-0.320_043_515_9);
            let c3 = _mm256_set1_ps(1.797_496_915_4);
            let c2 = _mm256_set1_ps(-4.198_804_617_6);
            let c1 = _mm256_set1_ps(5.727_023_169_5);
            let c0 = _mm256_set1_ps(-3.005_614_671_4);
...
impl SimdOps for F32x16 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            // Adjust to [√2/2, √2] range for better accuracy (centered at 1)
            // If f >= √2, divide by 2 and increment exponent
            let sqrt2 = _mm512_set1_ps(1.414_213_562_4);
            ...
            // Fitted using least squares on Chebyshev nodes
            // Max error: ~1e-4
            let c4 = _mm512_set1_ps(-0.320_043_515_9);
            let c3 = _mm512_set1_ps(1.797_496_915_4);
            let c2 = _mm512_set1_ps(-4.198_804_617_6);
            let c1 = _mm512_set1_ps(5.727_023_169_5);
            let c0 = _mm512_set1_ps(-3.005_614_671_4);
