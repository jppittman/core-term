...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            // Extract exponent: (x_i32 >> 23) - 127
            let exp_bits = _mm_srai_epi32(x_i32, 23); // Arithmetic shift preserves sign? Exponent is positive.
            // Actually srai is arithmetic, srli is logical. Exponent is in [30:23].
            // x_i32 can be negative if float is negative (but log2 is undefined).
            // Assuming positive inputs for log2.
            let exp_mask = _mm_set1_epi32(0xFF);
            let raw_exp = _mm_and_si128(exp_bits, exp_mask);
            let bias = _mm_set1_epi32(127);
            let n_i32 = _mm_sub_epi32(raw_exp, bias);
            let mut n = _mm_cvtepi32_ps(n_i32);
            ...
            // Max error: ~1e-4
            let c4 = _mm_set1_ps(-0.3200435);
            let c3 = _mm_set1_ps(1.7974969);
            let c2 = _mm_set1_ps(-4.1988046);
            let c1 = _mm_set1_ps(5.727023);
            let c0 = _mm_set1_ps(-3.0056148);
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            // Extract exponent: (x_i32 >> 23) - 127
            let exp_bits = _mm256_srai_epi32(x_i32, 23);
            let exp_mask = _mm256_set1_epi32(0xFF);
            let raw_exp = _mm256_and_si256(exp_bits, exp_mask);
            let bias = _mm256_set1_epi32(127);
            let n_i32 = _mm256_sub_epi32(raw_exp, bias);
            let mut n = _mm256_cvtepi32_ps(n_i32);
            ...
            // Fitted using least squares on Chebyshev nodes
            // Max error: ~1e-4
            let c4 = _mm256_set1_ps(-0.3200435);
            let c3 = _mm256_set1_ps(1.7974969);
            let c2 = _mm256_set1_ps(-4.1988046);
            let c1 = _mm256_set1_ps(5.727023);
            let c0 = _mm256_set1_ps(-3.0056148);
...
impl SimdOps for F32x16 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            // Fitted using least squares on Chebyshev nodes
            // Max error: ~1e-4
            let c4 = _mm512_set1_ps(-0.3200435);
            let c3 = _mm512_set1_ps(1.7974969);
            let c2 = _mm512_set1_ps(-4.1988046);
            let c1 = _mm512_set1_ps(5.727023);
            let c0 = _mm512_set1_ps(-3.0056148);
