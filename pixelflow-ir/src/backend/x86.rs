...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            let exp_masked = _mm_and_si128(exp_bits, _mm_set1_epi32(0xFF));
            let exp_val = _mm_sub_epi32(exp_masked, _mm_set1_epi32(127));
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let exp_masked = _mm256_and_si256(exp_bits, _mm256_set1_epi32(0xFF));
            let exp_val = _mm256_sub_epi32(exp_masked, _mm256_set1_epi32(127));
            ...
            let c2 = _mm256_set1_ps(-4.1988044);
...
impl SimdOps for F32x16 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let c2 = _mm512_set1_ps(-4.1988044);
