...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            // Extract exponent using integer shift and subtract bias
            let e_int = _mm_sub_epi32(_mm_srli_epi32(x_i32, 23), _mm_set1_epi32(127));
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            // Extract exponent using integer shift and subtract bias
            let e_int = _mm256_sub_epi32(_mm256_srli_epi32(x_i32, 23), _mm256_set1_epi32(127));
