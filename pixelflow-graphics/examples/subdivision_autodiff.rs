...
use pixelflow_graphics::subdivision::{SubdivisionGeometry, SubdivisionPatch, SubdivisionConfig};
...
fn main() {
    ...
    let config = SubdivisionConfig {
        base_height: -1.0, // intersection plane
        uv_scale: 1.0,
        center_x: 0.0,
        center_z: 0.0,
    };
    let geometry = SubdivisionGeometry::new(patch, &mesh, config);
