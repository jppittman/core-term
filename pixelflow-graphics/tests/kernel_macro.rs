...
#[test]
fn kernel_should_evaluate_correctly_with_one_param() {
...
#[test]
fn kernel_should_evaluate_correctly_with_two_params() {
    // Offset both X and Y
...
#[test]
fn kernel_should_evaluate_correctly_with_zero_params() {
...
#[test]
fn kernel_should_support_method_chaining() {
...
#[test]
fn kernel_should_implement_clone() {
...
#[test]
fn kernel_instantiations_should_be_independent() {
    let scale = kernel!(|factor: f32| X * factor);
...
/// Test sqrt method.
#[test]
fn sqrt_should_compute_square_root() {
...
/// Test abs method.
#[test]
fn abs_should_compute_absolute_value() {
...
#[test]
fn kernel_expression_should_be_copy() {
...
#[test]
fn kernel_should_support_three_params() {
...
#[test]
fn kernel_should_support_four_params() {
...
#[test]
fn kernel_should_implement_sphere_sdf_correctly() {
...
#[test]
fn kernel_should_bind_parameters_in_correct_order() {
...
#[test]
fn kernel_should_allow_parameter_reuse() {
...
#[test]
fn kernel_should_infer_jet3_output() {
...
#[test]
fn kernel_should_compute_jet3_derivatives_correctly() {
    // Sphere SDF: distance from center minus radius
...
#[test]
fn kernel_should_compose_with_other_kernels() {
...
#[test]
fn composed_kernel_should_handle_offsets() {
    let dist = kernel!(|cx: f32, cy: f32| {
        let dx = X - cx;
        let dy = Y - cy;
        (dx * dx + dy * dy).sqrt()
...
fn kernel_should_support_multiple_manifold_params() {
...
#[test]
fn kernel_should_support_mixed_params() {
...
#[test]
fn kernel_should_support_chained_composition() {
    // Basic X coordinate
    let get_x = kernel!(|| X);
...
#[test]
fn composed_kernel_should_own_inner_kernel() {
    let dist = kernel!(|cx: f32, cy: f32| {
        let dx = X - cx;
        let dy = Y - cy;
        (dx * dx + dy * dy).sqrt()
...
#[test]
fn kernel_should_handle_literals_in_jet3() {
...
#[test]
fn kernel_should_handle_multiple_literals_in_jet3() {
...
#[test]
fn kernel_should_handle_literals_and_params_in_jet3() {
    // offset + 2.0 * X - 0.5
...
#[test]
fn gradient_mag_2d_should_compute_magnitude() {
...
#[test]
fn gradient_mag_3d_should_compute_magnitude() {
...
#[test]
fn antialias_2d_should_compute_aa_factor() {
...
#[test]
fn antialias_3d_should_compute_aa_factor() {
...
#[test]
fn normalized_2d_should_return_unit_gradient() {
...
#[test]
fn fused_combinators_should_work_with_composition() {
...
#[test]
fn v_accessor_should_extract_value() {
...
#[test]
fn dx_accessor_should_extract_x_derivative() {
    // Distance from origin: sqrt(x² + y²)
...
#[test]
fn dy_accessor_should_extract_y_derivative() {
    // Distance from origin: sqrt(x² + y²)
...
#[test]
fn dz_accessor_should_extract_z_derivative() {
...
#[test]
fn manual_gradient_mag_should_match_fused() {
