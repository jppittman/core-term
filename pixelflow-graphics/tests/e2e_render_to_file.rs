...
fn e2e_render_gradient() {
    ...
    rasterize(&scene, frame.as_slice_mut(), shape, RenderOptions::default());
...
fn e2e_render_radial_gradient() {
    ...
    rasterize(&radial, frame.as_slice_mut(), shape, RenderOptions::default());
...
fn e2e_solid_color_renders_correctly() {
    ...
    rasterize(&cyan, frame.as_slice_mut(), shape, RenderOptions::default());
