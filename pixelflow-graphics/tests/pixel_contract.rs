...
#[test]
fn rgba8_should_store_components_correctly() {
...
#[test]
fn bgra8_should_store_components_correctly() {
...
#[test]
fn bgra8_should_swizzle_from_rgba8_correctly() {
    let rgba = Rgba8::new(0x11, 0x22, 0x33, 0x44);
...
#[test]
fn rgba8_should_convert_from_f32_correctly() {
...
#[test]
fn rgba8_should_convert_from_u32_correctly() {
