...
// Precomputed 256-color palette table
// This replaces expensive runtime calculation for indexed colors.
// Contains:
// - 0-15: Named Colors
// - 16-231: 6x6x6 Color Cube
// - 232-255: Grayscale Ramp
static PALETTE_256: [(u8, u8, u8); 256] = [
    (0, 0, 0),
    (205, 0, 0),
    (0, 205, 0),
    (205, 205, 0),
...
impl From<Color> for u32 {
    ...
    fn from(color: Color) -> u32 {
        let (r, g, b) = match color {
            ...
            // Use the static lookup table for all indexed colors
