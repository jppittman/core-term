...
impl NamedColor {
    ...
    pub fn to_rgb(self) -> (u8, u8, u8) {
        // SAFETY: NamedColor variants (0-15) map 1:1 to the first 16 entries of PALETTE_256.
        // Changing the order or values of NamedColor variants will break this mapping.
        PALETTE_256[self as usize]
    }
}
...
#[rustfmt::skip]
const PALETTE_256: [(u8, u8, u8); 256] = [
