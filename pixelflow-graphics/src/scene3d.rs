...
/// Epsilon for sphere intersection to prevent self-intersection artifacts.
const SPHERE_EPSILON: f32 = 0.0001;

/// Minimum cosine of incidence angle for reflection curvature scaling.
/// Prevents division by zero when ray grazes the surface.
const REFLECT_MIN_COS_INCIDENCE: f32 = 0.1;

/// Epsilon for vector normalization to prevent division by zero.
