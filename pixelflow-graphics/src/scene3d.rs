...
// Ray tracing epsilon for self-intersection avoidance
const SPHERE_EPSILON: f32 = 0.0001;

// Normal reconstruction and shading constants
const NORMAL_EPSILON: f32 = 1e-10;
const CURVATURE_MIN_COS: f32 = 0.1;
const CURVATURE_SCALE: f32 = 2.0;
...
impl<M: ManifoldCompat<Jet3, Output = Field>> Manifold<Jet3_4> for Reflect<M> {
    ...
    fn eval(&self, p: Jet3_4) -> Field {
        ...
        let curvature_scale = (Field::from(CURVATURE_SCALE) / cos_incidence).constant();
