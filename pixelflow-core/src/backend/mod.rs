...
//! All types and traits here are private - only `Field` is exposed publicly.
...
/// All SIMD operations in one trait.
///
/// This trait combines storage, arithmetic, comparison, and float-specific ops.
pub trait SimdOps:
    Copy
    + Clone
    + Debug
