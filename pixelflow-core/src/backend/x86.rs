...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            // Extract exponent using integer shift and cast
            let exp_bits = _mm_srli_epi32(x_i32, 23);
            let exp_bits = _mm_sub_epi32(exp_bits, _mm_set1_epi32(127));
            let mut n = _mm_cvtepi32_ps(exp_bits);
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let exp_bits = _mm256_sub_epi32(exp_bits, _mm256_set1_epi32(127));
            let mut n = _mm256_cvtepi32_ps(exp_bits);
