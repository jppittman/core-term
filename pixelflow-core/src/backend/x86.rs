...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            // Use integer shift and conversion
            ...
            let c3 = _mm_set1_ps(1.797_497);
            let c2 = _mm_set1_ps(-4.198_804_4);
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let c3 = _mm256_set1_ps(1.797_497);
            let c2 = _mm256_set1_ps(-4.198_804_4);
...
impl SimdOps for F32x16 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let c3 = _mm512_set1_ps(1.797_497);
            let c2 = _mm512_set1_ps(-4.198_804_4);
