...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            // Extract exponent as float using integer conversion
            // e = (bits >> 23) - 127
            let exp_bits = _mm_srli_epi32(x_i32, 23);
            let exponent_i32 = _mm_sub_epi32(exp_bits, _mm_set1_epi32(127));
            let mut n = _mm_cvtepi32_ps(exponent_i32);

            // Extract mantissa in [1, 2)
            // m = (bits & 0x007FFFFF) | 0x3F800000
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let exponent_i32 = _mm256_sub_epi32(exp_bits, _mm256_set1_epi32(127));
            let mut n = _mm256_cvtepi32_ps(exponent_i32);
