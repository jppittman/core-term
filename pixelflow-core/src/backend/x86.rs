...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            let exponent = _mm_sub_epi32(raw_exp, bias);
            let mut n = _mm_cvtepi32_ps(exponent);
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let exponent = _mm256_sub_epi32(raw_exp, bias);
            let mut n = _mm256_cvtepi32_ps(exponent);
