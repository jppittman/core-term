...
impl SimdOps for F32x4 {
    ...
    fn log2(self) -> Self {
        ...
        unsafe {
            ...
            let c2 = _mm_set1_ps(-4.198_804_6);
            let c1 = _mm_set1_ps(5.727_023);
            let c0 = _mm_set1_ps(-3.005_614_7);
...
impl SimdOps for F32x8 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let c2 = _mm256_set1_ps(-4.198_804_6);
            let c1 = _mm256_set1_ps(5.727_023);
            let c0 = _mm256_set1_ps(-3.005_614_7);
...
impl SimdOps for F32x16 {
    ...
    fn log2(self) -> Self {
        unsafe {
            ...
            let c2 = _mm512_set1_ps(-4.198_804_6);
            let c1 = _mm512_set1_ps(5.727_023);
            let c0 = _mm512_set1_ps(-3.005_614_7);
