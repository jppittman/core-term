...
impl Backend for Sse2 {
    ...
    fn inverse_mat3(m: [[f32; 3]; 3]) -> Option<[[f32; 3]; 3]> {
        unsafe {
            ...
            let mut c0 = [0.0; 4];
            col0_res.store(&mut c0 as *mut _ as *mut f32);
            let mut c1 = [0.0; 4];
            col1_res.store(&mut c1 as *mut _ as *mut f32);
            let mut c2 = [0.0; 4];
            col2_res.store(&mut c2 as *mut _ as *mut f32);
...
impl SimdVec<f32> {
    ...
    pub fn splat(val: f32) -> Self {
        unsafe { Self(cast_from_ps(_mm_set1_ps(val)), PhantomData) }
    }
}
...
impl Add for SimdVec<u32> {
    ...
    fn add(self, rhs: Self) -> Self {
        unsafe { Self(_mm_add_epi32(self.0, rhs.0), PhantomData) }
    }
}
impl Sub for SimdVec<u32> {
    type Output = Self;
    fn sub(self, rhs: Self) -> Self {
        unsafe { Self(_mm_sub_epi32(self.0, rhs.0), PhantomData) }
    }
}
impl Mul for SimdVec<u32> {
    type Output = Self;
    fn mul(self, rhs: Self) -> Self {
        unsafe { Self(_mm_mullo_epi32(self.0, rhs.0), PhantomData) }
    }
}
...
impl BitAnd for SimdVec<u32> {
    ...
    fn bitand(self, rhs: Self) -> Self {
        unsafe { Self(_mm_and_si128(self.0, rhs.0), PhantomData) }
    }
}
impl BitOr for SimdVec<u32> {
    type Output = Self;
    fn bitor(self, rhs: Self) -> Self {
        unsafe { Self(_mm_or_si128(self.0, rhs.0), PhantomData) }
    }
}
impl BitXor for SimdVec<u32> {
    type Output = Self;
    fn bitxor(self, rhs: Self) -> Self {
        unsafe { Self(_mm_xor_si128(self.0, rhs.0), PhantomData) }
    }
}
impl Not for SimdVec<u32> {
    type Output = Self;
    fn not(self) -> Self {
        unsafe { Self(_mm_xor_si128(self.0, _mm_set1_epi32(-1)), PhantomData) }
    }
}
impl Shl<i32> for SimdVec<u32> {
    type Output = Self;
    fn shl(self, rhs: i32) -> Self {
        unsafe { Self(_mm_sll_epi32(self.0, _mm_cvtsi32_si128(rhs)), PhantomData) }
    }
}
impl Shr<i32> for SimdVec<u32> {
    type Output = Self;
    fn shr(self, rhs: i32) -> Self {
        unsafe { Self(_mm_srl_epi32(self.0, _mm_cvtsi32_si128(rhs)), PhantomData) }
    }
}
    ...
    fn sequential_from(start: T) -> Self {
        unsafe {
            if core::mem::size_of::<T>() == 4 {
                ...
                Self(
                    _mm_set_epi32((s + 3) as i32, (s + 2) as i32, (s + 1) as i32, s as i32),
                    PhantomData,
                )
            } else if core::mem::size_of::<T>() == 1 {
                // u8 seq
...
impl Add for SimdVec<u16> {
    type Output = Self;
    fn add(self, rhs: Self) -> Self {
        unsafe { Self(_mm_add_epi16(self.0, rhs.0), PhantomData) }
    }
}
impl Sub for SimdVec<u16> {
    type Output = Self;
    fn sub(self, rhs: Self) -> Self {
        unsafe { Self(_mm_sub_epi16(self.0, rhs.0), PhantomData) }
    }
}
impl Mul for SimdVec<u16> {
    type Output = Self;
    fn mul(self, rhs: Self) -> Self {
        unsafe { Self(_mm_mullo_epi16(self.0, rhs.0), PhantomData) }
    }
}
...
impl Shl<i32> for SimdVec<u16> {
    type Output = Self;
    fn shl(self, rhs: i32) -> Self {
        unsafe { Self(_mm_sll_epi16(self.0, _mm_cvtsi32_si128(rhs)), PhantomData) }
    }
}
impl Shr<i32> for SimdVec<u16> {
    type Output = Self;
    fn shr(self, rhs: i32) -> Self {
        unsafe { Self(_mm_srl_epi16(self.0, _mm_cvtsi32_si128(rhs)), PhantomData) }
    }
}
...
impl BatchArithmetic<u16> for SimdVec<u16> {
    ...
    fn min(self, other: Self) -> Self {
        unsafe { Self(_mm_min_epi16(self.0, other.0), PhantomData) }
    }
    fn max(self, other: Self) -> Self {
        unsafe { Self(_mm_max_epi16(self.0, other.0), PhantomData) }
    }
    ...
    fn cmp_eq(self, other: Self) -> Self {
        unsafe { Self(_mm_cmpeq_epi16(self.0, other.0), PhantomData) }
    }
    fn cmp_ne(self, other: Self) -> Self {
        unsafe {
    ...
    fn cmp_lt(self, other: Self) -> Self {
        unsafe { Self(_mm_cmplt_epi16(self.0, other.0), PhantomData) }
    }
    fn cmp_le(self, other: Self) -> Self {
...
impl Add for SimdVec<u8> {
    type Output = Self;
    fn add(self, rhs: Self) -> Self {
        unsafe { Self(_mm_add_epi8(self.0, rhs.0), PhantomData) }
    }
}
impl Sub for SimdVec<u8> {
    type Output = Self;
    fn sub(self, rhs: Self) -> Self {
        unsafe { Self(_mm_sub_epi8(self.0, rhs.0), PhantomData) }
    }
}
impl Mul for SimdVec<u8> {
    type Output = Self;
    fn mul(self, _rhs: Self) -> Self {
        unimplemented!("u8 mul")
    }
}
...
impl BatchArithmetic<u8> for SimdVec<u8> {
    ...
    fn cmp_eq(self, other: Self) -> Self {
        unsafe { Self(_mm_cmpeq_epi8(self.0, other.0), PhantomData) }
    }
    fn cmp_ne(self, other: Self) -> Self {
        unsafe {
    ...
    fn cmp_lt(self, other: Self) -> Self {
        unsafe { Self(_mm_cmplt_epi8(self.0, other.0), PhantomData) }
    }
    fn cmp_le(self, other: Self) -> Self {
        let lt = self.cmp_lt(other);
        let eq = self.cmp_eq(other);
...
impl Add for SimdVec<f32> {
    ...
    fn add(self, rhs: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_add_ps(cast_to_ps(self.0), cast_to_ps(rhs.0))),
                PhantomData,
            )
        }
    }
...
impl Sub for SimdVec<f32> {
    ...
    fn sub(self, rhs: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_sub_ps(cast_to_ps(self.0), cast_to_ps(rhs.0))),
                PhantomData,
            )
        }
    }
...
impl Mul for SimdVec<f32> {
    ...
    fn mul(self, rhs: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_mul_ps(cast_to_ps(self.0), cast_to_ps(rhs.0))),
                PhantomData,
            )
        }
    }
...
impl Div for SimdVec<f32> {
    ...
    fn div(self, rhs: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_div_ps(cast_to_ps(self.0), cast_to_ps(rhs.0))),
                PhantomData,
            )
        }
    }
...
impl BatchArithmetic<f32> for SimdVec<f32> {
    ...
    fn gather(base: &[f32], indices: Self) -> Self {
        unimplemented!()
    }
    ...
    fn min(self, other: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_min_ps(cast_to_ps(self.0), cast_to_ps(other.0))),
                PhantomData,
            )
        }
    }
    fn max(self, other: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_max_ps(cast_to_ps(self.0), cast_to_ps(other.0))),
                PhantomData,
            )
        }
    }
    ...
    fn cmp_eq(self, other: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_cmpeq_ps(cast_to_ps(self.0), cast_to_ps(other.0))),
                PhantomData,
            )
        }
    }
    fn cmp_ne(self, other: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_cmpneq_ps(cast_to_ps(self.0), cast_to_ps(other.0))),
                PhantomData,
            )
        }
    }
    fn cmp_lt(self, other: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_cmplt_ps(cast_to_ps(self.0), cast_to_ps(other.0))),
                PhantomData,
            )
        }
    }
    fn cmp_le(self, other: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_cmple_ps(cast_to_ps(self.0), cast_to_ps(other.0))),
                PhantomData,
            )
        }
    }
    fn cmp_gt(self, other: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_cmpgt_ps(cast_to_ps(self.0), cast_to_ps(other.0))),
                PhantomData,
            )
        }
    }
    fn cmp_ge(self, other: Self) -> Self {
        unsafe {
            Self(
                cast_from_ps(_mm_cmpge_ps(cast_to_ps(self.0), cast_to_ps(other.0))),
                PhantomData,
            )
        }
    }
