...
impl SimdOps<u32> for SimdVec<u32> {
    ...
    fn shr(self, count: i32) -> Self {
        ...
        unsafe {
            ...
            Self(NeonReg { u32: vshlq_u32(self.0.u32, shift) })
        }
    }
    ...
    fn saturating_sub(self, other: Self) -> Self {
        ...
        unsafe { Self(NeonReg { u32: vqsubq_u32(self.0.u32, other.0.u32) }) }
    }
}
...
impl SimdOps<u16> for SimdVec<u16> {
    ...
    fn shr(self, count: i32) -> Self {
        ...
        unsafe {
            ...
            Self(NeonReg { u16: vshlq_u16(self.0.u16, shift) })
        }
    }
    ...
    fn saturating_sub(self, other: Self) -> Self {
        ...
        unsafe { Self(NeonReg { u16: vqsubq_u16(self.0.u16, other.0.u16) }) }
    }
}
...
impl SimdOps<u8> for SimdVec<u8> {
    ...
    fn shr(self, count: i32) -> Self {
        ...
        unsafe {
            ...
            Self(NeonReg { u8: vshlq_u8(self.0.u8, shift) })
        }
    }
    ...
    fn saturating_sub(self, other: Self) -> Self {
        ...
        unsafe { Self(NeonReg { u8: vqsubq_u8(self.0.u8, other.0.u8) }) }
    }
}
