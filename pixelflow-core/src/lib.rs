...
use crate::backend::{Backend, BatchOps, SimdBatch, BatchArithmetic};
use core::fmt::Debug;
    ...
    S: pipe::Surface<P> + ?Sized,
{
    ...
    for y in 0..height {
        ...
        while x + LANES <= width {
            ...
            let result_u32: <NativeBackend as Backend>::Batch<u32> = unsafe { core::mem::transmute_copy(&result) };
