...
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4), P)) -> V0 { p.0.0 }
}

// CtxVar<N1> - second element
impl<V0, V1, V2, V3, V4, P> Manifold<((V0, V1, V2, V3, V4), P)> for CtxVar<N1>
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4), P)) -> V1 { p.0.1 }
}

// CtxVar<N2> - third element
impl<V0, V1, V2, V3, V4, P> Manifold<((V0, V1, V2, V3, V4), P)> for CtxVar<N2>
where V2: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V2;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4), P)) -> V2 { p.0.2 }
}

// CtxVar<N3> - fourth element
impl<V0, V1, V2, V3, V4, P> Manifold<((V0, V1, V2, V3, V4), P)> for CtxVar<N3>
where V3: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V3;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4), P)) -> V3 { p.0.3 }
}

// CtxVar<N4> - fifth element
impl<V0, V1, V2, V3, V4, P> Manifold<((V0, V1, V2, V3, V4), P)> for CtxVar<N4>
where V4: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V4;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4), P)) -> V4 { p.0.4 }
}
...
// 4-element context
impl<P, V0, V1, V2, V3, B, O0, O1, O2, O3, Out> Manifold<P>
    for WithContext<(V0, V1, V2, V3), B>
where
    P: Copy + Send + Sync,
    V0: Manifold<P, Output = O0>,
    V1: Manifold<P, Output = O1>,
...
// 10-element context
impl<P, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, B, O0, O1, O2, O3, O4, O5, O6, O7, O8, O9, Out> Manifold<P>
    for WithContext<(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), B>
where
    P: Copy + Send + Sync,
    V0: Manifold<P, Output = O0>,
    V1: Manifold<P, Output = O1>,
    ...
    B: Manifold<((O0, O1, O2, O3, O4, O5, O6, O7, O8, O9), P), Output = Out>,
{
    ...
    fn eval(&self, p: P) -> Self::Output {
        ...
        self.body.eval(((v0, v1, v2, v3, v4, v5, v6, v7, v8, v9), p))
    }
}
...
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1), P)) -> V0 { p.0.0 }
}
...
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1), P)) -> V1 { p.0.1 }
}
...
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2), P)) -> V0 { p.0.0 }
}
...
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2), P)) -> V1 { p.0.1 }
}
...
where V2: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V2;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2), P)) -> V2 { p.0.2 }
}
...
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3), P)) -> V0 { p.0.0 }
}
...
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3), P)) -> V1 { p.0.1 }
}
...
where V2: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V2;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3), P)) -> V2 { p.0.2 }
}
...
where V3: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V3;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3), P)) -> V3 { p.0.3 }
}
...
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5), P)) -> V0 { p.0.0 }
}
...
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5), P)) -> V1 { p.0.1 }
}
...
where V2: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V2;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5), P)) -> V2 { p.0.2 }
}
...
where V3: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V3;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5), P)) -> V3 { p.0.3 }
}
...
where V4: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V4;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5), P)) -> V4 { p.0.4 }
}

impl<V0, V1, V2, V3, V4, V5, P> Manifold<((V0, V1, V2, V3, V4, V5), P)> for CtxVar<N5>
where V5: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V5;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5), P)) -> V5 { p.0.5 }
}
...
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6), P)) -> V0 { p.0.0 }
}
...
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6), P)) -> V1 { p.0.1 }
}
...
where V2: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V2;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6), P)) -> V2 { p.0.2 }
}
...
where V3: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V3;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6), P)) -> V3 { p.0.3 }
}
...
where V4: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V4;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6), P)) -> V4 { p.0.4 }
}
...
where V5: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V5;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6), P)) -> V5 { p.0.5 }
}

impl<V0, V1, V2, V3, V4, V5, V6, P> Manifold<((V0, V1, V2, V3, V4, V5, V6), P)> for CtxVar<N6>
where V6: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V6;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6), P)) -> V6 { p.0.6 }
}

// CtxVar impls for 8-element tuples
impl<V0, V1, V2, V3, V4, V5, V6, V7, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7), P)> for CtxVar<N0>
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7), P)) -> V0 { p.0.0 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7), P)> for CtxVar<N1>
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7), P)) -> V1 { p.0.1 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7), P)> for CtxVar<N2>
where V2: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V2;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7), P)) -> V2 { p.0.2 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7), P)> for CtxVar<N3>
where V3: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V3;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7), P)) -> V3 { p.0.3 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7), P)> for CtxVar<N4>
where V4: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V4;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7), P)) -> V4 { p.0.4 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7), P)> for CtxVar<N5>
where V5: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V5;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7), P)) -> V5 { p.0.5 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7), P)> for CtxVar<N6>
where V6: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V6;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7), P)) -> V6 { p.0.6 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7), P)> for CtxVar<N7>
where V7: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V7;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7), P)) -> V7 { p.0.7 }
}

// CtxVar impls for 9-element tuples
impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N0>
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V0 { p.0.0 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N1>
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V1 { p.0.1 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N2>
where V2: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V2;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V2 { p.0.2 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N3>
where V3: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V3;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V3 { p.0.3 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N4>
where V4: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V4;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V4 { p.0.4 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N5>
where V5: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V5;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V5 { p.0.5 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N6>
where V6: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V6;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V6 { p.0.6 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N7>
where V7: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V7;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V7 { p.0.7 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)> for CtxVar<N8>
where V8: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V8;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)) -> V8 { p.0.8 }
}

// CtxVar impls for 10-element tuples
impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N0>
where V0: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V0;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V0 { p.0.0 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N1>
where V1: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V1;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V1 { p.0.1 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N2>
where V2: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V2;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V2 { p.0.2 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N3>
where V3: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V3;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V3 { p.0.3 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N4>
where V4: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V4;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V4 { p.0.4 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N5>
where V5: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V5;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V5 { p.0.5 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N6>
where V6: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V6;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V6 { p.0.6 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N7>
where V7: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V7;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V7 { p.0.7 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N8>
where V8: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V8;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V8 { p.0.8 }
}

impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> Manifold<((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)> for CtxVar<N9>
where V9: Copy + Send + Sync, P: Copy + Send + Sync
{
    type Output = V9;
    #[inline(always)]
    fn eval(&self, p: ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)) -> V9 { p.0.9 }
}
...
impl<V0, V1, V2, V3, V4, V5, V6, V7, P> crate::domain::Spatial for ((V0, V1, V2, V3, V4, V5, V6, V7), P)
where P: crate::domain::Spatial
{
    type Coord = P::Coord;
    #[inline(always)]
...
impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, P> crate::domain::Spatial for ((V0, V1, V2, V3, V4, V5, V6, V7, V8), P)
where P: crate::domain::Spatial
{
    type Coord = P::Coord;
    #[inline(always)]
...
impl<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, P> crate::domain::Spatial for ((V0, V1, V2, V3, V4, V5, V6, V7, V8, V9), P)
where P: crate::domain::Spatial
{
    type Coord = P::Coord;
    #[inline(always)]
