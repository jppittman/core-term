...
fn bake_font() {
    ...
    let font_data = fs::read(font_path)
        .expect("Failed to read NotoSansMono-Regular.ttf");
    ...
    println!("cargo:warning=Pre-baked {} glyphs, total size: {} bytes", total_chars, all_glyph_data.len());
...
fn generate_baked_font_code(
    ...
    code.push_str(&format!("pub const FONT_SIZE_PT: f64 = {:.1};\n\n", font_size_px));
