...
use pixelflow_ir::{BindingTable, ExprArena, ExprId, LatticeShape, eval_scalar, pipeline};
...
use pixelflow_pipeline::real_corpus::{
    BENCH_EXTENT, BENCH_WIDE_EXTENT, CellGridCase, GuardTelemetry, capture_stderr, dag_cost,
    legalize, parse_guard_telemetry, reachable, real_kernels,
};
use pixelflow_search::egraph::{
    Budget, EpisodeLabels, KeepJournal, Optimizer, Rewrite, RuleSet, SaturationConfig, Vocabulary,
    all_rules, config_for_node_count, insert, reachable_count,
};
