...
#[cfg(feature = "training")]
use pixelflow_pipeline::nnue::HalfEPFeature;
#[cfg(feature = "training")]
use pixelflow_pipeline::training::{TrainingSample, BINPACK_MAGIC, BINPACK_VERSION};
...
fn write_binpack(path: &PathBuf, samples: &[TrainingSample]) -> std::io::Result<()> {
    ...
    for sample in samples {
        ...
        // The error was `use pixelflow_pipeline::training::{TrainingSample, ...}`.
