...
Per-expression rows: `docs/results/2026-09-01-r2g-ladder-r2g-bezier.jsonl` (80 expressions: classical 80). Skipped: none.
...
| (d) LinearReturnGuide[return-mse] @B [claim] | 0.857 / 0.857 / 0.928 (p90 0.996) | 80 / 0 / 0 | -9.52% / -9.52% / -0.37% (p90 0.0%) | 8.34% / 11.00% / 31.17% (p90 40.6%) | 1.038 / 2.300 / 2.700 (p90 2.700) (n=80) | 0.785 | 0.0981 | 3 |

Ladder diagnostics: linear < control on 60 expressions, equal on 20, linear > control on 0. control: quiesced before B on 0 / 80 (ended at 744.250 / 800.000 / 800.000 (p90 800.000) applications; burned-key share 0.000 / 0.000 / 0.000 (p90 0.000)); reaches the empirical best on 0; vs production cost better / equal / worse = 0 / 0 / 80. linear: quiesced before B on 0 / 80 (ended at 727.000 / 800.000 / 800.000 (p90 800.000) applications; burned-key share 0.000 / 0.000 / 0.000 (p90 0.000)); reaches the empirical best on 19; vs production cost better / equal / worse = 0 / 0 / 80. 
...
| (d) LinearReturnGuide[return-mse] @B [claim] | 0.857 / 0.857 / 0.914 (p90 1.000) | 60 / 20 / 0 | -6.90% / 0.00% / 6.60% (p90 6.6%) | 8.34% / 11.00% / 22.73% (p90 40.6%) | 0.730 / 0.730 / 1.700 (p90 1.700) (n=45) | 0.835 | 0.0503 | 4 |
...
| 20 | doubling | linear | 0 | 0 | 400 (0, 0.0%) | 20 |
...
| linear | 352 / 524 (67.2%) | 352 / 524 (67.2%) |
...
| linear | 0.785 | 0.835 | associative 2412, reverse-associative 1993, canonicalize 1342, fma-fusion 585, commutative 565, identity 504, constant-fold 380, distribute 219 |
...
- load_at_end: 19:32  up 51 days, 10:05, 2 users, load averages: 5.28 6.48 8.66
- load_at_start: 19:32  up 51 days, 10:05, 2 users, load averages: 5.80 6.66 8.78
