...
Per-expression rows: `docs/results/2026-09-01-r2g-ladder-r2g-dev.jsonl` (334 expressions: classical 334). Skipped: none.
...
|---|---|---|---|---|---|---|---|---|
| (a) unguided @B | 1.000 (by definition) | — | 0.39% / 51.66% / 178.61% (p90 48115.2%) | 53.71% / 95.54% / 27736.24% (p90 70799.3%) | 0 | 0.589 | 0.0212 | — |
| (b) unguided @4B | — | — | 0 | 0.00% / 1.03% / 57.29% (p90 20538.0%) | 1 | — | — | — |
| (c) PerRuleRateGuide @B [control] | 0.007 / 0.565 / 0.701 (p90 0.841) | 321 / 4 / 9 | -28.68% / 0.00% / 0.21% (p90 1.0%) | 0.00% / 0.60% / 5.32% (p90 21.0%) | 1.000 / 1.000 / 4.784 (p90 202.792) (n=308) | 0.279 | 0.2248 | 4 |
| (d) LinearReturnGuide[return-mse] @B [claim] | 0.005 / 0.549 / 0.736 (p90 0.842) | 324 / 4 / 6 | -24.08% / 0.00% / 0.46% (p90 2.5%) | 0.00% / 1.68% / 14.96% (p90 29.7%) | 1.000 / 1.000 / 13.693 (p90 220.928) (n=308) | 0.448 | 0.1726 | 3 |

Ladder diagnostics: linear < control on 31 expressions, equal on 103, linear > control on 200. control: quiesced before B on 41 / 334 (ended at 132.250 / 294.000 / 750.250 (p90 800.000) applications; burned-key share 0.000 / 0.000 / 0.000 (p90 0.000)); reaches the empirical best on 197; vs production cost better / equal / worse = 23 / 102 / 209. linear: quiesced before B on 42 / 334 (ended at 136.000 / 293.500 / 725.750 (p90 800.000) applications; burned-key share 0.000 / 0.000 / 0.000 (p90 0.000)); reaches the empirical best on 188; vs production cost better / equal / worse = 33 / 79 / 222. 

**Verdict (B=100):** (d) LinearReturnGuide[return-mse] median ratio vs unguided-at-B = **0.549** against the registered threshold ≤ 0.837 (Y = 16.3%) — the Y-clause **HOLDS**; median gap vs unguided-at-4B = 0.00% against ≤ 24.2% — the 4B-approach clause **HOLDS**; (d) beats unguided-at-B at all (median ratio < 1.0, kill-gate view). Ladder: (c) control median ratio 0.565, regret 0.60% vs (d) regret 1.68% — (d) **does not beat** (c).

**Round-1b domain-shift statistic (S = classical):** M_B = 0.06. D_control = -0.0000 (m_control^S = 0.5655, m_control^DEV = 0.5655). D_linear = 0.0127 (m_linear^S = 0.5493, m_linear^DEV = 0.5366). D_control − D_linear = -0.0128 → **H_null**. §1.2 polynomial prediction: both arms D ≤ 0: FAILS; both arms D ≤ M_B: holds.
...
| arm | ratio vs unguided@B (q1/med/q3, p90) | improved / unchanged / worse | gap vs unguided@4B | regret vs best | gap closed (n with gap) | structural share @B | strict precision @B | rounds to B (med) |
|---|---|---|---|---|---|---|---|---|
| (a) unguided @B | 1.000 (by definition) | — | 0.00% / 16.89% / 78.93% (p90 29102.3%) | 0.68% / 50.93% / 163.94% (p90 49550.6%) | 0 | 0.596 | 0.0296 | — |
| (b) unguided @4B | — | — | 0 | 0.00% / 0.00% / 5.10% (p90 15322.9%) | 1 | — | — | — |
| (c) PerRuleRateGuide @B [control] | 0.522 / 0.699 / 1.000 (p90 1.000) | 245 / 71 / 18 | 0.00% / 0.00% / 0.23% (p90 2.8%) | 0.00% / 0.19% / 2.68% (p90 15.9%) | 0.994 / 1.000 / 1.000 (p90 2.063) (n=228) | 0.403 | 0.1422 | 5 |
| (d) LinearReturnGuide[return-mse] @B [claim] | 0.525 / 0.714 / 1.000 (p90 1.000) | 244 / 71 / 19 | 0.00% / 0.00% / 0.40% (p90 1.9%) | 0.00% / 0.31% / 2.34% (p90 24.7%) | 0.989 / 1.000 / 1.000 (p90 1.996) (n=228) | 0.496 | 0.1322 | 5 |

Ladder diagnostics: linear < control on 30 expressions, equal on 186, linear > control on 118. control: quiesced before B on 126 / 334 (ended at 132.250 / 294.000 / 750.250 (p90 800.000) applications; burned-key share 0.000 / 0.000 / 0.000 (p90 0.000)); reaches the empirical best on 197; vs production cost better / equal / worse = 20 / 138 / 176. linear: quiesced before B on 127 / 334 (ended at 136.000 / 293.500 / 725.750 (p90 800.000) applications; burned-key share 0.000 / 0.000 / 0.000 (p90 0.000)); reaches the empirical best on 188; vs production cost better / equal / worse = 22 / 133 / 179. 

**Verdict (B=200):** (d) LinearReturnGuide[return-mse] median ratio vs unguided-at-B = **0.714** against the registered threshold ≤ 0.910 (Y = 9.0%) — the Y-clause **HOLDS**; median gap vs unguided-at-4B = 0.00% against ≤ 11.0% — the 4B-approach clause **HOLDS**; (d) beats unguided-at-B at all (median ratio < 1.0, kill-gate view). Ladder: (c) control median ratio 0.699, regret 0.19% vs (d) regret 0.31% — (d) **does not beat** (c).

**Round-1b domain-shift statistic (S = classical):** M_B = 0.07. D_control = 0.0000 (m_control^S = 0.6991, m_control^DEV = 0.6991). D_linear = 0.0178 (m_linear^S = 0.7137, m_linear^DEV = 0.6959). D_control − D_linear = -0.0177 → **H_null**. §1.2 polynomial prediction: both arms D ≤ 0: FAILS; both arms D ≤ M_B: holds.
...
| 34 | even-negation | linear | 1154 (386, 33.4%) | 1455 (398, 27.4%) | 1712 (398, 23.2%) | 257 |
| 36 | sin-angle-addition | unguided | 0 | 9 (0, 0.0%) | 1953 (2, 0.1%) | 64 |
| 36 | sin-angle-addition | control | 28 (0, 0.0%) | 72 (0, 0.0%) | 278 (1, 0.4%) | 61 |
| 36 | sin-angle-addition | linear | 83 (1, 1.2%) | 119 (1, 0.8%) | 312 (2, 0.6%) | 62 |
...
| 37 | cos-angle-addition | linear | 74 (2, 2.7%) | 150 (4, 2.7%) | 381 (5, 1.3%) | 65 |
...
| 38 | reverse-angle-addition | linear | 71 (19, 26.8%) | 101 (20, 19.8%) | 230 (20, 8.7%) | 59 |
| 39 | half-angle-product | unguided | 0 | 0 | 3171 (0, 0.0%) | 17 |
| 39 | half-angle-product | control | 0 | 0 | 23 (0, 0.0%) | 6 |
| 39 | half-angle-product | linear | 2 (0, 0.0%) | 3 (0, 0.0%) | 26 (0, 0.0%) | 7 |
...
| linear | 6209 / 7588 (81.8%) | 4917 / 6290 (78.2%) |
...
| linear | 0.448 | 0.496 | commutative 7623, even-negation 7146, fma-fusion 2813, involution 2764, power-recip 1873, associative 1826, reverse-associative 1773, power-sqrt 1307 |
...
- effective B (applications at stop): 399.750 / 1671.000 / 9441.000 (p90 24535.400) (max 85941)
...
- production regret vs empirical best: 0.00% / 0.00% / 0.00% (p90 12748.2%)
...
- load_at_end: 19:32  up 51 days, 10:04, 2 users, load averages: 6.34 6.82 8.90
- load_at_start: 19:31  up 51 days, 10:04, 2 users, load averages: 6.33 6.90 9.06
