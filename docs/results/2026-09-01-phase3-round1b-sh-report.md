...
Per-expression rows: `docs/results/2026-09-01-phase3-round1b-sh.jsonl` (95 expressions: classical 95). Skipped: none.
...
Population counts over the FULL classical DEV corpus loaded this run (n = 95), by first-matching stratum:
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| trig-heavy | 100 | 95 | 0.903 | 0.904 | 0.3373 | 0.3673 | -0.0300 | 0.06 | H_null |
| trig-heavy | 200 | 95 | 0.894 | 0.896 | 0.1949 | 0.2000 | -0.0051 | 0.07 | H_null |
...
### set = trig-heavy (n = 95, rows with rule-index histogram = 95)
...
- load_at_end: 18:09  up 51 days,  8:42, 2 users, load averages: 6.22 6.20 5.98
- load_at_start: 18:09  up 51 days,  8:41, 2 users, load averages: 7.01 6.34 6.02
