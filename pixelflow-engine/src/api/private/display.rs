//! Display system message types (internal).
//!
//! These types represent platform events sent from display drivers to the engine.
//! - WindowId: Opaque window identifier for multi-window support
//! - DisplayEvent: Platform events (keyboard, mouse, window lifecycle)
